...
struct ListItem: View {
    ...
    let objects:[Object] = [
        ...
        Object(NameObject: "Helm of the warrior", category: "Head", color: Color("Color-2"), qta: "1"),
        Object(NameObject: "Helm of the warrior", category: "Head", color: Color("Color-2"), qta: "1"),
        Object(NameObject: "Helm of the warrior", category: "Head", color: Color("Color-3"), qta: "Quantity"),
        Object(NameObject: "Helm of the warrior", category: "Head", color: Color("Color-3"), qta: "Quantity"),
        Object(NameObject: "Helm of the warrior", category: "Head", color: Color("Color-4"), qta: "Quantity"),
        Object(NameObject: "Helm of the warrior", category: "Head", color: Color("Color-5"), qta: "Quantity"),
        Object(NameObject: "Helm of the warrior", category: "Head", color: Color("Color-5"), qta: "Quantity"),
    ...
    var body: some View {
        ...
        VStack(spacing:10){
            ...
            HStack{
                ...
                NavigationLink(destination:CreateItem()){
